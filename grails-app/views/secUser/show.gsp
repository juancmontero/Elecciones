            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.nombre.label" default="Nombre" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "nombre")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.apellidoPaterno.label" default="Apellido Paterno" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "apellidoPaterno")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.apellidoMaterno.label" default="Apellido Materno" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "apellidoMaterno")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.telefonoCelular.label" default="Telefono Celular" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "telefonoCelular")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.telefonoCasa.label" default="Telefono Casa" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "telefonoCasa")}</td>
