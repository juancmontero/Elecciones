            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secRole.descripcionRol.label" default="Descripcion Rol" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secRoleInstance, field: "descripcionRol")}</td>
