                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="descripcionRol"><g:message code="secRole.descripcionRol.label" default="Descripcion Rol" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: secRoleInstance, field: 'descripcionRol', 'errors')}">
                                    <g:textField name="descripcionRol" value="${secRoleInstance?.descripcionRol}" />
                                </td>
                            </tr>
